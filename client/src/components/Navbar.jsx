    ...
    <header className='navbar'>
            <nav className={`${clicked ? "open-nav" : ""}`}>
              <svg onClick={handleClick} className="close" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="20.1009" y1="2.11892" x2="2.11892" y2="21.8991" stroke="#27DEBF" stroke-width="3" stroke-linecap="round"/>
                <line x1="20.1009" y1="21.8991" x2="1.8991" y2="2.11892" stroke="#27DEBF" stroke-width="3" stroke-linecap="round"/>
              </svg>
              <ul>
                <li>
                  <Link onClick={handleClick} className='link'>INICIO</Link>
                </li>
                <div class="line"></div>
                <li>
                  <Link onClick={handleClick} className='link'>SOBRE MI</Link>
                </li>
                <div class="line"></div>
                <li>
                  <Link onClick={handleClick} className='link'>EDUCACION</Link>
                </li>
                <div class="line"></div>
                <li>
                  <Link onClick={handleClick} className='link'>HABILIDADES</Link>
                </li>
                <div class="line"></div>
                <li>
                  <Link onClick={handleClick} className='link'>EXPERIENCIA</Link>
                </li>
              </ul>
            </nav>
            ...
            <svg onClick={handleClick} className="menu" width="34" height="25" viewBox="0 0 34 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="32.5" y1="1.5" x2="1.5" y2="1.5" stroke="#27DEBF" stroke-width="3" stroke-linecap="round"/>
                <line x1="32.5" y1="12.5" x2="1.5" y2="12.5" stroke="#27DEBF" stroke-width="3" stroke-linecap="round"/>
                <line x1="32.5" y1="23.5" x2="1.5" y2="23.5" stroke="#27DEBF" stroke-width="3" stroke-linecap="round"/>
            </svg>
    </header>
  )
}
